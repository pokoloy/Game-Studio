        ...
        <section id="contact" className="contact-form section-padding">
            ...
            <div className="container">
                ...
                <div className="col-md-12">
                    <h2 className="display-4 contactus-title-head">Contact Us</h2>
                </div>
                </div>
                <div className="row">
                ...
                <div className="col-lg-4 col-md-6 col-xs-12">
                    ...
                    <a href="#"><i className="lni-envelope icons cyan-color contact-info-icon"></i>info@gamesstudiodev.com</a>
                    <a href="#"><i className="lni-tab icons cyan-color contact-info-icon"></i>http://gamesstudiodev.com/</a>
                    </div>
                </div>
                </div>
            </div>
