                ...
                <div className="container">
                  <div className="row section text-center">
                     <div className="col-12">
                        <h2 className="display-4 about-title-head">About</h2>
                      </div>
                  </div>
                     <div className="row">
                        <div className="col text-center">
                           <p className="lead">We here at Game Studio Development are not only game developers, but are also gamers ourselves.
